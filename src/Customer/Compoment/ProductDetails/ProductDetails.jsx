...
'use client'
import { Avatar, Grid, Grid2, LinearProgress } from '@mui/material'
            ...
            <div className="pt-6">
                ...
                lg:pb-24">
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">123</h1>
                            <h1 className="text-lg lg:text-xl text-gray-900 opacity-60">123</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className='flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6'>
                                <p className="font-semibold">20000 VNĐ</p>
                                <p className="opacity-50 line-through">200000 VNĐ</p>
                            ...
                            <div className="mt-6">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">3800 reviews</p>
                                </div>
                            </div>
                ...
                <section>
                    ...
                    <div className="border p-5">
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5} >
                                <h1 className="text-xl font-semibold pd-1">Đánh giá sản phẩm</h1>
                                <div className="flex items-center space-x-3">
                                    <Rating value={4.6} precision={.5} readOnly />
                                    <p className="opacity-60">50000 Đánh giá</p>
                                </div>
                                <Box className="mt-5">
                ...
                <section className="pt-10">
                    ...
                    <div className="flex flex-wrap space-y-5">
                        {Sm_Tablet.map((item)=><HomeSectionCard product={item}/>)}
                    </div>
                </section>
