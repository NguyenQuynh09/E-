...
export const findProducts = (reqData) => async (dispatch) => {
    ...
    const { colors, minPrice, maxPrice, minDiscount, category, stock, sort, pageNumber, pageSize } = reqData;

    try {
     const {data}=await api.get(`/api/products/color=${colors}& minPrice${minPrice}&maxPrice${maxPrice}&
